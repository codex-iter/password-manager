  ...
  function () {
    ...
    checkPageButton.addEventListener (
      ...
      function () {
        ...
        // console.log(localStorage.key(email))
        if (email.length > 0) {
          if (localStorage.getItem(email) == null) {
            console.log (email);
            window.alert ('Please save your login credetials first!');
          }
